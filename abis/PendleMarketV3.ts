const PendleMarketV3Abi = [
  {
    inputs: [
      { internalType: "address", name: "_PT", type: "address" },
      { internalType: "int256", name: "_scalarRoot", type: "int256" },
      { internalType: "int256", name: "_initialAnchor", type: "int256" },
      { internalType: "uint80", name: "_lnFeeRateRoot", type: "uint80" },
      { internalType: "address", name: "_vePendle", type: "address" },
      { internalType: "address", name: "_gaugeController", type: "address" },
    ],
  ...
  {
    inputs: [
      { internalType: "int256", name: "currentAmount", type: "int256" },
      { internalType: "int256", name: "requiredAmount", type: "int256" },
    ],
  ...
  {
    inputs: [{ internalType: "int256", name: "scalarRoot", type: "int256" }],
    name: "MarketScalarRootBelowZero",
    type: "error",
  },
  { inputs: [], name: "MarketZeroAmountsInput", type: "error" },
  { inputs: [], name: "MarketZeroAmountsOutput", type: "error" },
  { inputs: [], name: "MarketZeroLnImpliedRate", type: "error" },
  {
    inputs: [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: "address", name: "receiverSy", type: "address" },
      { indexed: true, internalType: "address", name: "receiverPt", type: "address" },
      { indexed: false, internalType: "uint256", name: "netLpBurned", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "netSyOut", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "netPtOut", type: "uint256" },
    ],
    name: "Burn",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "netSyUsed", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "netPtUsed", type: "uint256" },
    ],
    name: "Mint",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256[]", name: "rewardsOut", type: "uint256[]" },
    ],
    name: "RedeemRewards",
    type: "event",
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: "address", name: "receiver", type: "address" },
      { indexed: false, internalType: "int256", name: "netPtOut", type: "int256" },
      { indexed: false, internalType: "int256", name: "netSyOut", type: "int256" },
      { indexed: false, internalType: "uint256", name: "netSyFee", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "netSyToReserve", type: "uint256" },
    ],
    name: "Swap",
    type: "event",
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint256", name: "lnLastImpliedRate", type: "uint256" },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "receiverSy", type: "address" },
      { internalType: "address", name: "receiverPt", type: "address" },
      { internalType: "uint256", name: "netLpToBurn", type: "uint256" },
    ],
    name: "burn",
    outputs: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint216", name: "lnImpliedRateCumulative", type: "uint216" },
  ...
  },
  {
    ...
    name: "observe",
    outputs: [{ internalType: "uint216[]", name: "lnImpliedRateCumulative", type: "uint216[]" }],
    stateMutability: "view",
    type: "function",
  },
  {
    ...
    outputs: [
      {
        components: [
          { internalType: "int256", name: "totalPt", type: "int256" },
          { internalType: "int256", name: "totalSy", type: "int256" },
          { internalType: "int256", name: "totalLp", type: "int256" },
          { internalType: "address", name: "treasury", type: "address" },
          { internalType: "int256", name: "scalarRoot", type: "int256" },
          { internalType: "uint256", name: "expiry", type: "uint256" },
          { internalType: "uint256", name: "lnFeeRateRoot", type: "uint256" },
          { internalType: "uint256", name: "reserveFeePercent", type: "uint256" },
          { internalType: "uint256", name: "lastLnImpliedRate", type: "uint256" },
        ],
  ...
  { inputs: [], name: "skim", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "receiver", type: "address" },
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "receiver", type: "address" },
      { internalType: "uint256", name: "exactPtOut", type: "uint256" },
      { internalType: "bytes", name: "data", type: "bytes" },
    ],
...
export default PendleMarketV3Abi;