const EtherFiDepositAdapterAbi = [
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "enum DepositAdapter.SourceOfFunds", name: "source", type: "uint8" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "address", name: "_referral", type: "address" },
      {
        ...
        internalType: "struct ILiquifier.PermitInput",
        name: "_permit",
        type: "tuple",
      },
    ],
    name: "depositStETHForWeETHWithPermit",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  ...
  },
  {
    ...
    name: "depositWstETHForWeETHWithPermit",
    outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export default EtherFiDepositAdapterAbi;
